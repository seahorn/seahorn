...
static inline Expr
checkChildrenAll(Expr exp, TypeChecker &tc,
...
oneOrMore(Expr exp, TypeChecker &tc,
  ...
  return checkChildren<GreaterEqual, 1, T, Types...>(exp, tc, returnTypeFn);
}

template <typename returnType, typename T, typename... Types>
static inline Expr oneOrMore(Expr exp, TypeChecker &tc) {
  return checkChildren<GreaterEqual, 1, T, Types...>(exp, tc,
