...
protected:
  ...
  solver::SolverResult pathEncodingAndSolveWithSmt(
  ...
  bool pathEncodingAndSolveWithCrab(PathBmcTrace &trace,
  ...
  void assertCrabInvariants(const expr_invariants_map_t &invariants, SymStore &s);
