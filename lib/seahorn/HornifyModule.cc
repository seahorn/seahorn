...
#include "seahorn/FeasibleHornifyFunction.hh"
...
namespace hm_detail {enum Step {SMALL_STEP, LARGE_STEP, CLP_SMALL_STEP, FLAT_LARGE_STEP, FEASIBLE_SMALL_STEP};}
...
Step("horn-step",
     ...
     cl::values (clEnumValN (hm_detail::SMALL_STEP, "small", "Small Step"),
                 ...
                 clEnumValN (hm_detail::FEASIBLE_SMALL_STEP, "feasiblesmall", "Small Step encoding feasibility"),
                 clEnumValEnd),
...
namespace seahorn
{
  ...
  bool HornifyModule::runOnFunction (Function &F)
  {
    ...
    else if (Step == hm_detail::FEASIBLE_SMALL_STEP)
      hf.reset (new FeasibleSmallHornifyFunction (*this, InterProc));
