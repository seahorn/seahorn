; ModuleID = 'floppy_simpl3_true.cil.o3.bc'
...
_L___0:                                           ; preds = %LeafBlock81, %LeafBlock83
  br i1 %82, label %__UFO__2, label %bb17

bb17:                                             ; preds = %_L___0
  %87 = icmp eq i32 %s.0, 2
  br i1 %87, label %bb18, label %bb21

bb18:                                             ; preds = %bb17
  %88 = icmp eq i32 %81, 259
  br i1 %88, label %UnifiedReturnBlock, label %__UFO__2

bb21:                                             ; preds = %bb17
  %89 = icmp eq i32 %81, %lowerDriverReturn.2
  br i1 %89, label %__UFO__2, label %UnifiedReturnBlock

__UFO__2:                                         ; preds = %__UFO__2, %bb21, %bb18, %_L___0, %_L___1, %_L___2, %FloppyPnp.exit
  br label %__UFO__2

UnifiedReturnBlock:                               ; preds = %bb21, %bb18, %LeafBlock81, %LeafBlock83, %bb31.i
  ret i32 42
}
