; ModuleID = 'floppy_simpl4_true.cil.o3.bc'
...
switch_2_2:                                       ; preds = %bb5
  ...
  br i1 %or.cond.i, label %bb2.i, label %bb1.i3

bb1.i3:                                           ; preds = %switch_2_2
...
bb4.i:                                            ; preds = %bb2.i
  %58 = icmp eq i32 %22, 0
  br i1 %58, label %bb2.i28.i, label %bb9.i9
...
bb9.i9:                                           ; preds = %bb4.i
  ...
  br i1 %63, label %switch_13_exp_0.i, label %bb10.i10

bb10.i10:                                         ; preds = %bb9.i9
  %64 = icmp eq i32 %32, %42
  br i1 %64, label %switch_13_exp_1.i, label %bb11.i11

bb11.i11:                                         ; preds = %bb10.i10
  %65 = icmp eq i32 %32, %43
  %66 = icmp eq i32 %32, %44
  %or.cond1.i = or i1 %66, %65
  br i1 %or.cond1.i, label %switch_13_exp_3.i, label %bb13.i12

bb13.i12:                                         ; preds = %bb11.i11
...
switch_13_exp_1.i:                                ; preds = %bb10.i10
  %76 = icmp eq i32 %27, 0
...
switch_13_exp_3.i:                                ; preds = %bb11.i11
  %80 = icmp slt i32 %30, %31
  br i1 %80, label %switch_2_break, label %bb33.i16

bb33.i16:                                         ; preds = %switch_13_exp_3.i
  ...
  %85 = icmp eq i32 %83, 0
  %or.cond.i.i15 = and i1 %85, %84
  br i1 %or.cond.i.i15, label %bb35.i, label %switch_2_break

bb35.i:                                           ; preds = %bb33.i16
  %86 = icmp eq i32 %32, %51
  br i1 %86, label %bb36.i17, label %switch_13_exp_7.i

bb36.i17:                                         ; preds = %bb35.i
...
switch_13_exp_7.i:                                ; preds = %bb36.i17, %bb35.i, %bb13.i12
...
bb2.i20.i:                                        ; preds = %bb1.i19.i
  ...
  %96 = icmp eq i32 %95, 0
  %.0.i.i.i18 = select i1 %96, i32 0, i32 -1073741823
  %97 = icmp slt i32 %.0.i.i.i18, 0
  br i1 %97, label %switch_13_break.i, label %bb4.i.i21

bb4.i.i21:                                        ; preds = %bb2.i20.i
  %98 = tail call i32 @__VERIFIER_nondet_int() nounwind
  %99 = icmp eq i32 %98, 0
  %.0.i2.i.i19 = select i1 %99, i32 0, i32 -1073741823
  %100 = icmp slt i32 %.0.i2.i.i19, 0
...
bb3.i17.i:                                        ; preds = %bb2.i16.i
  ...
  br i1 %107, label %switch_2_break, label %switch_8_default.i.i26

switch_8_default.i.i26:                           ; preds = %bb3.i17.i
  br label %switch_2_break

switch_13_break.i.thread12:                       ; preds = %bb29.i, %bb23.i
  br label %switch_2_break

switch_13_break.i:                                ; preds = %bb45.i, %bb4.i.i21, %bb2.i20.i
  %ntStatus.0.i38 = phi i32 [ %ntStatus.1.i, %bb45.i ], [ %.0.i.i.i18, %bb2.i20.i ], [ %.0.i2.i.i19, %bb4.i.i21 ]
  %108 = icmp eq i32 %ntStatus.0.i38, 259
  br i1 %108, label %return.i, label %switch_2_break

return.i:                                         ; preds = %switch_13_break.i, %bb4.i.i21, %bb1.i19.i
  %pended.4.reg2mem.0 = phi i32 [ 1, %bb1.i19.i ], [ 1, %bb4.i.i21 ], [ 0, %switch_13_break.i ]
  %ntStatus.0.i38.reg2mem.0 = phi i32 [ 259, %bb1.i19.i ], [ 259, %bb4.i.i21 ], [ %ntStatus.0.i38, %switch_13_break.i ]
  br label %switch_2_break
...
switch_2_break:                                   ; preds = %switch_8_default.i.i, %bb3.i.i, %bb2.i.i, %switch_8_default.i9.i, %bb3.i8.i, %bb2.i7.i, %switch_8_default.i28.i, %bb3.i27.i, %bb2.i26.i, %bb31.i, %bb30.i, %switch_8_default.i76.i, %bb3.i75.i, %bb2.i74.i, %switch_8_default.i98.i, %bb3.i97.i, %bb2.i96.i, %FlQueueIrpToThread.exit.i, %bb13.i, %switch_8_default.i133.i, %bb3.i132.i, %bb2.i131.i, %bb13.i158.i, %while_1_break.i.i, %FlFdcDeviceIo.exit.i.i, %bb6.i152.i, %switch_2_3, %return.i, %switch_13_break.i, %switch_13_break.i.thread12, %switch_8_default.i.i26, %bb3.i17.i, %bb2.i16.i, %switch_13_exp_9.i, %switch_13_exp_7.i, %bb36.i17, %bb33.i16, %switch_13_exp_3.i, %bb29.i, %switch_13_exp_1.i, %bb23.i, %switch_13_exp_0.i, %switch_8_default.i30.i, %bb3.i29.i, %bb2.i28.i, %bb2.i, %bb1.i3, %bb4, %entry
  %s.0 = phi i32 [ 1, %return.i ], [ %s.1, %bb1.i3 ], [ 4, %switch_8_default.i30.i ], [ 4, %switch_8_default.i.i26 ], [ 4, %switch_8_default.i133.i ], [ 4, %switch_8_default.i98.i ], [ 4, %switch_8_default.i76.i ], [ 4, %switch_8_default.i28.i ], [ 4, %switch_8_default.i.i ], [ 4, %switch_8_default.i9.i ], [ 2, %switch_13_break.i.thread12 ], [ 2, %entry ], [ 2, %bb4 ], [ 2, %bb2.i ], [ 4, %bb2.i28.i ], [ 4, %bb3.i29.i ], [ 2, %switch_13_exp_0.i ], [ 2, %bb23.i ], [ 2, %switch_13_exp_1.i ], [ 2, %bb29.i ], [ 2, %switch_13_exp_3.i ], [ 2, %bb33.i16 ], [ 2, %bb36.i17 ], [ 2, %switch_13_exp_7.i ], [ 2, %switch_13_exp_9.i ], [ 4, %bb2.i16.i ], [ 4, %bb3.i17.i ], [ 2, %switch_13_break.i ], [ 2, %switch_2_3 ], [ 2, %while_1_break.i.i ], [ 2, %FlFdcDeviceIo.exit.i.i ], [ 2, %bb6.i152.i ], [ 2, %bb13.i158.i ], [ 4, %bb2.i131.i ], [ 4, %bb3.i132.i ], [ 2, %bb13.i ], [ 2, %FlQueueIrpToThread.exit.i ], [ 4, %bb2.i96.i ], [ 4, %bb3.i97.i ], [ 4, %bb2.i74.i ], [ 4, %bb3.i75.i ], [ 2, %bb30.i ], [ 2, %bb31.i ], [ 4, %bb2.i26.i ], [ 4, %bb3.i27.i ], [ 4, %bb2.i7.i ], [ 4, %bb3.i8.i ], [ 4, %bb2.i.i ], [ 4, %bb3.i.i ]
  %pended.2 = phi i32 [ %pended.4.reg2mem.0, %return.i ], [ %pended.0, %bb1.i3 ], [ 0, %switch_8_default.i30.i ], [ 0, %switch_8_default.i.i26 ], [ 0, %switch_8_default.i133.i ], [ %pended.5.reg2mem.0, %switch_8_default.i98.i ], [ 0, %switch_8_default.i76.i ], [ 0, %switch_8_default.i28.i ], [ 0, %switch_8_default.i.i ], [ 0, %switch_8_default.i9.i ], [ 0, %switch_13_break.i.thread12 ], [ 0, %entry ], [ 0, %bb4 ], [ 0, %bb2.i ], [ 0, %bb2.i28.i ], [ 0, %bb3.i29.i ], [ 0, %switch_13_exp_0.i ], [ 0, %bb23.i ], [ 0, %switch_13_exp_1.i ], [ 0, %bb29.i ], [ 0, %switch_13_exp_3.i ], [ 0, %bb33.i16 ], [ 0, %bb36.i17 ], [ 0, %switch_13_exp_7.i ], [ 0, %switch_13_exp_9.i ], [ 0, %bb2.i16.i ], [ 0, %bb3.i17.i ], [ 0, %switch_13_break.i ], [ 0, %switch_2_3 ], [ 0, %while_1_break.i.i ], [ 0, %FlFdcDeviceIo.exit.i.i ], [ 0, %bb6.i152.i ], [ 0, %bb13.i158.i ], [ 0, %bb2.i131.i ], [ 0, %bb3.i132.i ], [ 0, %bb13.i ], [ 0, %FlQueueIrpToThread.exit.i ], [ %pended.5.reg2mem.0, %bb2.i96.i ], [ %pended.5.reg2mem.0, %bb3.i97.i ], [ 0, %bb2.i74.i ], [ 0, %bb3.i75.i ], [ 0, %bb30.i ], [ 0, %bb31.i ], [ 0, %bb2.i26.i ], [ 0, %bb3.i27.i ], [ 0, %bb2.i7.i ], [ 0, %bb3.i8.i ], [ 0, %bb2.i.i ], [ 0, %bb3.i.i ]
  %lowerDriverReturn.2 = phi i32 [ 0, %return.i ], [ 0, %bb1.i3 ], [ 259, %switch_8_default.i30.i ], [ 259, %switch_8_default.i.i26 ], [ 259, %switch_8_default.i133.i ], [ 259, %switch_8_default.i98.i ], [ 259, %switch_8_default.i76.i ], [ 259, %switch_8_default.i28.i ], [ 259, %switch_8_default.i.i ], [ 259, %switch_8_default.i9.i ], [ 0, %switch_13_break.i.thread12 ], [ 0, %entry ], [ 0, %bb4 ], [ 0, %bb2.i ], [ 0, %bb2.i28.i ], [ -1073741823, %bb3.i29.i ], [ 0, %switch_13_exp_0.i ], [ 0, %bb23.i ], [ 0, %switch_13_exp_1.i ], [ 0, %bb29.i ], [ 0, %switch_13_exp_3.i ], [ 0, %bb33.i16 ], [ 0, %bb36.i17 ], [ 0, %switch_13_exp_7.i ], [ 0, %switch_13_exp_9.i ], [ 0, %bb2.i16.i ], [ -1073741823, %bb3.i17.i ], [ 0, %switch_13_break.i ], [ 0, %switch_2_3 ], [ %lowerDriverReturn.9, %bb13.i158.i ], [ %returnVal2.0.i.i.i.reg2mem.1, %bb6.i152.i ], [ %lowerDriverReturn.9, %FlFdcDeviceIo.exit.i.i ], [ %lowerDriverReturn.9, %while_1_break.i.i ], [ 0, %bb2.i131.i ], [ -1073741823, %bb3.i132.i ], [ 0, %bb13.i ], [ 0, %FlQueueIrpToThread.exit.i ], [ 0, %bb2.i96.i ], [ -1073741823, %bb3.i97.i ], [ 0, %bb2.i74.i ], [ -1073741823, %bb3.i75.i ], [ %returnVal2.0.i57.i.reg2mem.0, %bb30.i ], [ %returnVal2.0.i57.i.reg2mem.1, %bb31.i ], [ 0, %bb2.i26.i ], [ -1073741823, %bb3.i27.i ], [ 0, %bb2.i7.i ], [ -1073741823, %bb3.i8.i ], [ 0, %bb2.i.i ], [ -1073741823, %bb3.i.i ]
  %status.0 = phi i32 [ %56, %bb1.i3 ], [ %ntStatus.0.i38.reg2mem.0, %return.i ], [ 259, %switch_8_default.i30.i ], [ 259, %switch_8_default.i.i26 ], [ 259, %switch_8_default.i133.i ], [ 259, %switch_8_default.i98.i ], [ 259, %switch_8_default.i76.i ], [ 259, %switch_8_default.i28.i ], [ 259, %switch_8_default.i.i ], [ 259, %switch_8_default.i9.i ], [ -2147483643, %switch_13_break.i.thread12 ], [ 0, %entry ], [ 0, %bb4 ], [ -1073741738, %bb2.i ], [ 0, %bb2.i28.i ], [ -1073741823, %bb3.i29.i ], [ -1073741811, %switch_13_exp_0.i ], [ 0, %bb23.i ], [ -1073741811, %switch_13_exp_1.i ], [ 0, %bb29.i ], [ -1073741811, %switch_13_exp_3.i ], [ -1073741811, %bb33.i16 ], [ -1073741811, %bb36.i17 ], [ -1073741101, %switch_13_exp_7.i ], [ -1073741789, %switch_13_exp_9.i ], [ 0, %bb2.i16.i ], [ -1073741823, %bb3.i17.i ], [ %ntStatus.0.i38, %switch_13_break.i ], [ -1073741738, %switch_2_3 ], [ %ntStatus.0.i.i.reg2mem.0, %bb13.i158.i ], [ -1073741670, %bb6.i152.i ], [ %129, %FlFdcDeviceIo.exit.i.i ], [ %129, %while_1_break.i.i ], [ 0, %bb2.i131.i ], [ -1073741823, %bb3.i132.i ], [ -1073741823, %bb13.i ], [ -1073741823, %FlQueueIrpToThread.exit.i ], [ 0, %bb2.i96.i ], [ -1073741823, %bb3.i97.i ], [ 0, %bb2.i74.i ], [ -1073741823, %bb3.i75.i ], [ 0, %bb30.i ], [ %ntStatus.3.i, %bb31.i ], [ 0, %bb2.i26.i ], [ -1073741823, %bb3.i27.i ], [ 0, %bb2.i7.i ], [ -1073741823, %bb3.i8.i ], [ 0, %bb2.i.i ], [ -1073741823, %bb3.i.i ]
...
_L___0:                                           ; preds = %LeafBlock105, %NodeBlock119, %NodeBlock119
  br i1 %177, label %__UFO__2, label %bb20

bb20:                                             ; preds = %_L___0
  %182 = icmp eq i32 %s.0, 2
  br i1 %182, label %bb21, label %bb24

bb21:                                             ; preds = %bb20
  %183 = icmp eq i32 %status.0, 259
  br i1 %183, label %UnifiedReturnBlock, label %__UFO__2

bb24:                                             ; preds = %bb20
  %184 = icmp eq i32 %status.0, %lowerDriverReturn.2
  br i1 %184, label %__UFO__2, label %UnifiedReturnBlock

__UFO__2:                                         ; preds = %__UFO__2, %bb24, %bb21, %_L___0, %_L___1, %_L___2, %switch_2_break
  br label %__UFO__2

UnifiedReturnBlock:                               ; preds = %bb24, %bb21, %LeafBlock105, %NodeBlock119, %bb31.i
  ret i32 42
}
