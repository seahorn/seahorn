...
// 2>&1 | OutputCheck %s RUN: %sea bpf -O3 --horn-bmc-crab=false  --bmc=path
// --bound=5  --horn-stats --inline  --log=bmc "%s" 2>&1 | OutputCheck %s
// #: %sea bpf -O3 --horn-bmc-crab=true  --bmc=path --bound=5  --horn-stats
// --inline  --log=bmc "%s" 2>&1 | OutputCheck %s CHECK: ^sat$
