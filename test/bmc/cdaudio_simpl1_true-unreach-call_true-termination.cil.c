...
// RUN: %sea bpf -O3 --horn-bmc-crab=false --horn-bmc-muc=assume  --bmc=path --bound=5  --horn-stats --inline "%s" 2>&1 | filecheck %s
// -- Disabled because it takes too long
// %sea bpf -O3 --horn-bmc-crab=false --horn-bmc-muc=quickXplain  --bmc=path --bound=5  --horn-stats --inline --dsa=sea-ci "%s" 2>&1 | filecheck %s
// RUN: %sea bpf -O3 --horn-bmc-crab=true --horn-bmc-muc=assume  --bmc=path --bound=5  --horn-stats --inline --dsa=sea-ci "%s" 2>&1 | filecheck %s
// RUN: %sea bpf -O3 --horn-gsa --bmc=mono --bound=5  --horn-stats --inline --dsa=sea-ci "%s" 2>&1 | filecheck %s
// CHECK: {{^unsat$}}
