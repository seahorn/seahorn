...
// %sea bpf -O3 --horn-bmc-crab=false --horn-bmc-muc=assume  --bmc=path --bound=5  --horn-stats --inline "%s" 2>&1 | OutputCheck %s
// %sea bpf -O3 --horn-bmc-crab=false --horn-bmc-muc=quickXplain  --bmc=path --bound=5  --horn-stats --inline --dsa=llvm "%s" 2>&1 | OutputCheck %s
// %sea bpf -O3 --horn-bmc-crab=true --horn-bmc-muc=assume  --bmc=path --bound=5  --horn-stats --inline --dsa=llvm "%s" 2>&1 | OutputCheck %s
