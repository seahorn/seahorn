...
// %sea bpf -O0 --horn-bmc-crab=false  --bmc=path --horn-bmc-muc=assume --bound=10  --horn-stats --inline  "%s" 2>&1 | OutputCheck %s
// %sea bpf -O0 --horn-bmc-crab=false  --bmc=path --horn-bmc-muc=quickXplain --bound=10  --horn-stats --inline  "%s" 2>&1 | OutputCheck %s
// %sea bpf -O0 --horn-bmc-crab=true  --bmc=path --bound=10  --horn-stats --inline  "%s" 2>&1 | OutputCheck %s
