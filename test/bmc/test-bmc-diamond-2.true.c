...
// %sea bpf -O0 --horn-bmc-crab=false --horn-bmc-muc=assume  --bmc=path --bound=10  --horn-stats --inline "%s" 2>&1 | OutputCheck %s
// %sea bpf -O0 --horn-bmc-crab=false --horn-bmc-muc=quickXplain  --bmc=path --bound=10  --horn-stats --inline "%s" 2>&1 | OutputCheck %s
// %sea bpf -O0 --horn-bmc-crab=true --horn-bmc-muc=assume  --bmc=path --bound=10  --horn-stats --inline "%s" 2>&1 | OutputCheck %s
