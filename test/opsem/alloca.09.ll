...
; RUN: %seabmc --sea-opsem-allocator=static --horn-hybrid-array "%s" 2>&1 | %oc %s
...
entry:
  %sz = call i32 @nd()
  ;; large allocation, should get unsat
  %lb = icmp ule i32 8000, %sz
  %ub = icmp ule i32 %sz, 8192
