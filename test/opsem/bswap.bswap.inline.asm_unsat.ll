...
; ModuleID = 'bswap.bswap.inline.asm_unsat.ll'
...
entry:
  ...
  %5 = tail call i64 asm "bswap $0", "=r,0,~{dirflag},~{fpsr},~{flags}"(i64 %2) #6, !srcloc !3
  %6 = tail call i64 asm "bswap $0", "=r,0,~{dirflag},~{fpsr},~{flags}"(i64 %3) #6, !srcloc !4
  %7 = icmp eq i64 %5, %6
