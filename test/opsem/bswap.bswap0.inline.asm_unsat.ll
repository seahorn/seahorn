...
; ModuleID = 'bswap.bswap0.inline.asm_unsat.ll'
source_filename = "../opsem2/bswap/bswap-ntoh64-inline-asm_unsat.c"
target datalayout = "e-m:e-p:32:32-p270:32:32-p271:32:32-p272:64:64-f64:32:64-f80:32-n8:16:32-S128"
target triple = "i386-pc-linux-gnu"

declare dso_local i64 @nd_uint64_t() local_unnamed_addr #0
...
entry:
  %2 = tail call i64 @nd_uint64_t() #5
  %3 = tail call i64 @nd_uint64_t() #5
  %4 = icmp eq i64 %2, %3
  tail call void @verifier.assume(i1 %4) #5
  %5 = tail call i64 asm "bswap ${0:q}", "=r,0,~{dirflag},~{fpsr},~{flags}"(i64 %2) #6, !srcloc !3
  %6 = tail call i64 asm "bswap ${0:q}", "=r,0,~{dirflag},~{fpsr},~{flags}"(i64 %3) #6, !srcloc !4
  %7 = icmp eq i64 %5, %6
