...
; ModuleID = 'bswap.bswapq.inline.asm_unsat.ll'
source_filename = "../opsem2/bswap/bswap-foo-inline-asm_unsat.c"
...
entry:
  ...
  %5 = tail call i64 asm "bswapq ${0:q}", "=r,0,~{dirflag},~{fpsr},~{flags}"(i64 %2) #6, !srcloc !3
  %6 = tail call i64 asm "bswapq ${0:q}", "=r,0,~{dirflag},~{fpsr},~{flags}"(i64 %3) #6, !srcloc !4
  %7 = icmp eq i64 %5, %6
