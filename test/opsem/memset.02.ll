...
; RUN: %seabmc --horn-based-ptr-obj --horn-hybrid-array --horn-hybrid-use-arm --horn-hybrid-compress-stores --log=opsem3 "%s" 2>&1 | %oc %s
...
;  call void @llvm.memcpy.p0i8.p0i8.i32(i8* %3, i8* %4, i32 32, i32 1, i1 false) #4
  call void @llvm.memset.p0i8.i32(i8* %3, i8 12, i32 32, i32 4, i1 false) #4
  ;; chose one of the allocation sites
  %c = call i1 @nondet.bool()
  %ptr = select i1 %c, [32 x i8]* %malloc2.i, [32 x i8]* %malloc13.i
  %5 = getelementptr inbounds [32 x i8], [32 x i8]* %ptr, i32 0, i32 12
