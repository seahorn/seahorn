...
; RUN: %seabmc --horn-hybrid-array --horn-gsa "%s" 2>&1 | %oc %s
; RUN: %seabmc --horn-hybrid-array --horn-vcgen-use-ite "%s" 2>&1 | %oc %s
; RUN: %seabmc --horn-hybrid-array --horn-gsa --horn-vcgen-use-ite "%s" 2>&1 | %oc %s
