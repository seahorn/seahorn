...
entry:
  ...
  store i32 32, i32* %z
  %cmp2 = icmp ne i32 %nd1, 5
  %z2 = select i1 %cmp2, i32* %x, i32* %y
  store i32 42, i32* %z2
  %a = load i32, i32* %x
  %b = load i32, i32* %y
  %sum = add nsw i32 %b, %a
  %c = icmp eq i32 %sum, 74 ; true ==> no aliasing
  %d = icmp eq i32* %z, %z2 ; true ==> aliasing
  %f = icmp eq i1 %c, %d    ; should never be true
  call void @verifier.assume(i1 %f)
