...
entry:
  ...
  store i32 -2147483648, i32* %y, align 4
  %z1 = load i32, i32* %x, align 4
  %z2 = load i32, i32* %y, align 4
  %res = call {i32, i1} @llvm.ssub.with.overflow.i32(i32 %z2, i32 %z1)
  %sub1 = extractvalue {i32, i1} %res, 0
  %compare = icmp eq i32 %sub1, 2147483647
  call void @verifier.assume(i1 %compare)
  %sub2 = extractvalue {i32, i1} %res, 1
  %compare2 = icmp eq i1 %sub2, 1
  call void @verifier.assume(i1 %compare2)
