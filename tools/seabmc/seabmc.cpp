...
///
// SeaBMC -- BMC engine part of SeaHorn
///
...
{
  llvm::outs () << "SeaBMC part of SeaHorn (http://seahorn.github.io/):\n"
                << "  SeaBMC version " << SEAHORN_VERSION_INFO << "\n";
}
...
static llvm::cl::opt<seabmc::ZTraceLogOpt, true, llvm::cl::parser<std::string> >
TraceOption ("ztrace",
             llvm::cl::desc ("Enable z3 trace level"),
             llvm::cl::location (seabmc::ztrace),
             llvm::cl::value_desc ("string"),
             llvm::cl::ValueRequired, llvm::cl::ZeroOrMore,
             llvm::cl::Hidden);

static llvm::cl::opt<seabmc::ZVerboseOpt, true, llvm::cl::parser<int> >
VerboseOption ("zverbose",
               llvm::cl::desc ("Z3 verbosity level"),
               llvm::cl::location (seabmc::zverbose),
...
int main(int argc, char **argv) {
  ufo::ScopedStats _st ("seabmc_total");
